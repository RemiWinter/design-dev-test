    ...
    <section className='container' id='cards'>
      <div className="cards-top">
        <div className="img-div card1">
          <img src="./design-dev-test/card_img1.png" alt="" />
          <div className="copy-overlay">
            <h1>Activities and clubs</h1>
            <img className='arrow' src="./design-dev-test/arrow.svg" alt="" />
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
          </div>
        </div>
        <div className="img-div card2">
          <img src="./design-dev-test/card_img2.png" alt="" />  
          <div className="copy-overlay">
            <h1>Accommodation</h1>
            <img className='arrow' src="./design-dev-test/arrow.svg" alt="" />
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
      ...
      <div className="cards-bottom">
        <div className="img-div card3">
          <img src="./design-dev-test/card_img3.png" alt="" />
          <div className="copy-overlay">
        ...
        <div className="img-div card4">
          <img src="./design-dev-test/card_img4.png" alt="" />  
          <div className="copy-overlay">
            <h1>Support</h1>
            <img className='arrow' src="./design-dev-test/arrow.svg" alt="" />
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
        ...
        <div className="img-div card5">
          <img src="./design-dev-test/card_img5.png" alt="" />  
          <div className="copy-overlay">
